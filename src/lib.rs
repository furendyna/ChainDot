...
#[derive(Debug)]
pub struct ChainDotProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainDotProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainDot processing");
    
    let mut processor = ChainDotProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainDotProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainDotProcessor::new(false);
